...
- published papers: 10
- published batches: 2
- analyzed rows across batches: 1,050,484
- headline estimates with p < .05: 2
- latest batch: April 5, 2026

## Latest batch

- [Arts, Cassiman, and Hou (2023)](papers/2026-04-05/arts-cassiman-hou-2023-technology-space.pdf) - rows: 5,192, entities: 443, `tech_diff = -0.1935`; `p = 0.78`
- [Ghosh, Martin, Pennings, and Wezel (2014)](papers/2026-04-05/ghosh-martin-pennings-wezel-2014-ambition-focus.pdf) - rows: 489,193, entities: 200, `breadth x org_recomb_exp_log = -0.0022`; `p = 0.008`
- [Katila and Ahuja (2002)](papers/2026-04-05/katila-ahuja-2002-search-behavior.pdf) - rows: 2,174, entities: 162, `search_scope = 0.0052`; `p = 0.62`
- [Katila and Chen (2008)](papers/2026-04-05/katila-chen-2008-search-timing.pdf) - rows: 4,839, entities: 167, `ahead vs sync on event quality = -0.0854`; `p = 0.12`
- [Rosenkopf (2001)](papers/2026-04-05/rosenkopf-2001-beyond-local-search.pdf) - rows: 23,844, entities: 184, `boundary_existing_field vs local = -0.0389`; `p = 0.39`
